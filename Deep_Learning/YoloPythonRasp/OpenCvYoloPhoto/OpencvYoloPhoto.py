...
If you dont't insert name photo-file as running parameter --photo (Ex. --photo mypicture.jpg) the program start a chooser
file dialog.
...
prepath = os.path.join(root, "home", "pi", "AIData")     # ex. linux
